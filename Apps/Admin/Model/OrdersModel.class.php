	 ...
	 */
     ...
     public function queryByPage(){
        $shopName = WSTAddslashes(I('shopName'));
	 	...
	 	$sql = "select o.orderId,o.orderNo,o.totalMoney,o.realTotalMoney,o.orderStatus,o.deliverMoney,o.payType,o.createTime,s.shopName,o.userName,o.useScore,o.coupId from __PREFIX__orders o
