...
class GoodsModel extends BaseModel {
	...
	public function queryOnSaleByPage(){
		...
		$sql = "select g.goodsId,g.goodsSn,g.goodsName,g.goodsImg,g.goodsThums,g.shopPrice,g.goodsStock,g.saleCount,g.isSale,g.isSaleout,g.isRecomm,g.isHot,g.isBest,g.isMiaosha,g.isScore,g.ispintuan,g.exchangeScore,g.ismiaoshatime,g.ptrs,g.ptlastdate,g.isNew,ga.isRecomm as attIsRecomm from __PREFIX__goods g
				left join __PREFIX__goods_attributes ga on g.goodsId = ga.goodsId and ga.isRecomm = 1
				where g.goodsFlag=1 
